...
yum install --enablerepo=webtatic-testing php70w-fpm php70w-opcache php70w-cli php70w-common php70w-gd php70w-mbstring php70w-mcrypt php70w-pdo php70w-xml php70w-mysqlnd -y
